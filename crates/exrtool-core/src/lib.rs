...
pub fn generate_preview(
    ...
    for oy in 0..out_h {
        for ox in 0..out_w {
            ...
            if tone_map != ToneMapKind::None && tone_map_order == ToneMapOrder::BeforeLut {
                let rgb = apply_tone_map([r, g, b], tone_map);
                r = rgb[0];
                g = rgb[1];
                b = rgb[2];
            }
            ...
            if tone_map != ToneMapKind::None && tone_map_order == ToneMapOrder::AfterLut {
                let rgb = apply_tone_map([r, g, b], tone_map);
                r = rgb[0];
                g = rgb[1];
                b = rgb[2];
